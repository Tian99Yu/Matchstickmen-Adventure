...
public class MatchstickMenActivityDoublePlayer extends SuperMatchstickMenActivity implements CustomizableGame, Saver {
    /**
    ...
    void setOnclickListeners() {
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (!gameView.gameBackend.isGameOver()) {
                            ...
                            String compareOutput = (((MatchstickMenBackend) gameView.gameBackend).compare(result1, result2));
        ...
        singlePlayer.setOnClickListener(
                new GameView.OnClickListener() {
                    public void onClick(View view) {
                        Intent mainIntent = new Intent(MatchstickMenActivityDoublePlayer.this, MatchstickMenActivity.class);

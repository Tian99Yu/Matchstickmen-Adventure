...
class CollisionHandler {
  ...
  static void handle(AsteroidGameObject first, AsteroidGameObject second) {
    ...
    } else if (first instanceof Asteroid && second instanceof Ship) {
      collision = new ShipAsteroidCollision(second, first);
    } else if (first instanceof Projectile && second instanceof Asteroid) {
      collision = new ProjectileAsteroidCollision(first, second);
    } else if (first instanceof Asteroid && second instanceof Projectile) {
      collision = new ProjectileAsteroidCollision(second, first);
